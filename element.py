...
class Element:
    def __init__(self, mes, i, j, iter):
        self.iter = iter
        self.i, self.j = i, j
        self.mes = mes
    ...
    def calculate_b(self):
        ...
        q5u = quad(f5, a, b, vec_func=False, maxiter=self.iter)[0]
        q6u = quad(f6, c, d, vec_func=False, maxiter=self.iter)[0]
        q7u = quad(f7, a, b, vec_func=False, maxiter=self.iter)[0]
        q8u = quad(f8, c, d, vec_func=False, maxiter=self.iter)[0]

        q5l = quad(g5, a, b, vec_func=False, maxiter=self.iter)[0]
        q6l = quad(g6, c, d, vec_func=False, maxiter=self.iter)[0]
        q7l = quad(g7, a, b, vec_func=False, maxiter=self.iter)[0]
        q8l = quad(g8, c, d, vec_func=False, maxiter=self.iter)[0]
